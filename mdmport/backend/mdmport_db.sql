...
CREATE TABLE IF NOT EXISTS `c_gamephotos` (
  ...
  PRIMARY KEY (`id`),
  KEY `gameid` (`gameid`),
  CONSTRAINT `c_gamephotos_ibfk_1`
    FOREIGN KEY (`gameid`) REFERENCES `b_games` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `d_ownedg` (
  ...
  KEY `gameid` (`gameid`),
  CONSTRAINT `d_ownedg_ibfk_1`
    FOREIGN KEY (`userid`) REFERENCES `a_users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `d_ownedg_ibfk_2`
    FOREIGN KEY (`gameid`) REFERENCES `b_games` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;


INSERT IGNORE INTO `a_users` (`id`, `username`, `password`, `role`, `preferences`) VALUES
(1, 'Admin',   '$2b$12$LxKFdUGTxSax1OQRj8o/1uqx1CwfwSeEfsOQNk.OSVJmVAlVYJtWO', 'admin', NULL),
(2, 'Bulya',   '$2b$12$yjlwvXFu.1SPhLLIUS7f.eLAKuVFqPk2lYw0samGc2qsw3Ih5z49G', 'user', NULL),
(3, 'Szakacs', '$2b$12$wl0TyjcupGDoQlyt3JdgXuaNQxT48xQJUStQcE.SVyQyjQUEmI6Zy', 'user', NULL),
(4, 'Marci',   '$2b$12$nevQMoKcFS9qM6UXj7oT8.rbD781b1AA8cboe5gzcJAVIHusgsYIi', 'user', NULL);
...
(10, 'Where Winds Meet',         'top free', 'INGYEN',  'Wuxia akció-RPG.',                          'https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/3564740/a6ddae369ac5ea3963775e17ef82c1c65794bed9/header_alt_assets_2.jpg?t=1772758997'),
